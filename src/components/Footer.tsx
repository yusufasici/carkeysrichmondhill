          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                ...
                <a href="tel:+14168165740" className="hover:text-primary transition-colors">
                  (416) 816-5740
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                ...
                <a href="https://wa.me/14168165740" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  WhatsApp Message
                </a>
              </li>
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
